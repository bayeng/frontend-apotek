                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <select name="id_penerima" class="js-example-theme-single js-states form-control" id="id_label_single">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <select required name="id_obat" type="text" class="form-control" aria-label="Last name">
